...
## Wie man die Befehlszeile auf dem Computer benutzt
...
`php yellow.php build` = Statische Webseite erstellen, [erfordert Static-Erweiterung](https://github.com/annaesvensson/yellow-update/tree/main/README-de.md)  
