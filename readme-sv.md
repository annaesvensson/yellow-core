...
Du kan uppdatera din webbplats i en webbläsare eller via kommandoraden. Du kan hitta information om [senaste produktändringar](https://datenstrom.se/sv/yellow/help/what-s-new) i hjälpen. Tänk på att endast tillägg som är tillgängliga på den officiella webbplatsen kommer att uppdateras, eventuellt måste du uppdatera experimentella tillägg manuellt. [Läs mer om uppdatering](https://github.com/annaesvensson/yellow-update/tree/main/readme-sv.md).
